...
for (i = 0; i < 6; i++){
  var catNameGuess = prompt('Can you guess any of the ' + catNames.length + ' nicknames for my cat?');
  if (catNames.includes(catNameGuess)){
    alert('Yea it is! I would have also accept ' + catNames - catNameGuess + ' .');
  }
}
